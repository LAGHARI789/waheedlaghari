...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mwaheed laghari\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : B4_LAGHARI_M4_MASTER
\033[1;92m☞ WhatsApp   : 03347283126
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update LA_LAGHARI Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' LA_LAGHARI WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/LA-LAGHARI')
	    os.system('cd $HOME && git clone https://github.com/waheedlaghari laghari')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03347283126✓')
	    psb('WellCome To LA_LAGHARI')
	    psb('Congratulations LA_LAGHARI Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel B4 BALOCH M4 MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/LA_LAGHARI&& python2 M4.py')
	elif bm =='3':
